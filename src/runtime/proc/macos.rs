...
pub(super) fn make_dir_searchable(dir: &OwnedFd, name: &CStr) -> rustix::io::Result<()> {
    rustix::fs::chmodat(dir, name, rustix::fs::Mode::RWXU, rustix::fs::AtFlags::SYMLINK_NOFOLLOW)
}
...
pub(in crate::runtime::proc) fn holder_from_status(status: u32) -> Holder {
    match status {
...
pub(in crate::runtime::proc) fn render_start_time(tvsec: u64, tvusec: u64) -> Option<String> {
...
pub(in crate::runtime::proc) fn start_instant(tvsec: u64, tvusec: u64) -> Option<jiff::Timestamp> {
...
pub(in crate::runtime::proc) fn look(uid: u32, pid: u32) -> Seen {
    classify(
        uid,
...
pub(in crate::runtime::proc) fn classify(
    uid: u32,
...
pub(in crate::runtime::proc) fn signalable(pid: u32) -> bool {
    let Ok(raw) = i32::try_from(pid) else { return false };
    let Some(pid) = Pid::from_raw(raw) else { return false };
...
/// boundary.
pub(in crate::runtime::proc) mod ffi {
    use std::mem;
    ...
    pub(in crate::runtime::proc) fn all_pids() -> Result<Vec<u32>, ProcError> {
    ...
    pub(in crate::runtime::proc) enum InfoError {
    ...
    ///
    /// See [`InfoError`].
    pub(in crate::runtime::proc) fn bsd_info(pid: u32) -> Result<libc::proc_bsdinfo, InfoError> {
    ...
    pub(in crate::runtime::proc) fn name(pid: u32) -> Option<String> {
